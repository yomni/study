...
public class OrderRepository {
    ...
    public List<jpabook.jpashop.domain.Order> findAll(OrderSearch orderSearch) {
    ...
    public List<OrderSimpleQueryDto> findOrderDtos() {
        return em.createQuery(
//                        "select new jpabook.jpashop.repository.OrderSimpleQueryDto(o.id, m.name, o.status, o.orderDate, d.status, d.address)" +
